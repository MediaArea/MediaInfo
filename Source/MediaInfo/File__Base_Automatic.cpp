...
void File__Base_DefaultLanguage (Translation &Info)
{
    ...
    "Format_Settings_MuxingMode;Format settings, Muxing mode\n"
    ...
    "OveralBitRate;Overal bit rate\n"
    "OveralBitRate_Maximum;Maximum overal bit rate\n"
    "OveralBitRate_Minimum;Minimum overal bit rate\n"
    "OveralBitRate_Mode;Overal bit rate mode\n"
    "OveralBitRate_Nominal;Nominal overal bit rate\n"
    "Part;Part\n"
...
void File__Base_CodecID_Video (InfoMap &Info)
{
    ...
    "dvsd;Sony;4CC;Digital Video\n"
    "dvsl;Sony;4CC;Digital Video\n"
    ...
    "XVID;XviD;4CC;MPEG-4 Visual;;;;http://www.xvid.org/Downloads.15.0.html\n"
...
void File__Base_CodecID_Audio (InfoMap &Info)
{
    ...
    "0;;2CC\n"
    "1;Microsoft;2CC;PCM;;CBR;;http://www.microsoft.com/windows/\n"
...
void File__Base_General (ZtringListList &Info)
{
    ...
    "StreamKind;General;General;N NI;;;Stream type name\n"
    ...
    "Chapters_Codec_List;;;N NT;;;Deprecated\n"
    ...
    "CodecID/String;;;Y NT;;;Codec ID used (text)\n"
    "CodecID/Info;;;Y NT;;;Info about codec ID\n"
    "CodecID/Hint;;;N NT;;;A hint for this codec ID\n"
    ...
    "OveralBitRate_Mode;;;Y YT;;;Bit rate mode of all streams (VBR, CBR)\n"
    "OveralBitRate;; bps;N YF;;;Bit rate of all streams\n"
    "OveralBitRate/String;;;Y NT;;;Bit rate of all streams (with measure)\n"
    "OveralBitRate_Minimum;; bps;N YF;;;Minimum Bit rate in bps\n"
    "OveralBitRate_Minimum/String;;;Y NT;;;Minimum Bit rate (with measurement)\n"
    "OveralBitRate_Nominal;; bps;N YF;;;Nominal Bit rate in bps\n"
    "OveralBitRate_Nominal/String;;;Y NT;;;Nominal Bit rate (with measurement)\n"
    "OveralBitRate_Maximum;; bps;N YF;;;Maximum Bit rate in bps\n"
    "OveralBitRate_Maximum/String;;;Y NT;;;Maximum Bit rate (with measurement)\n"
...
void File__Base_Video (ZtringListList &Info)
{
    ...
    "Count;;;N NI;;;Count of objects available in this stream\n"
    "StreamCount;;;N NI;;;Count of streams of that kind available\n"
    "StreamKind;Video;Video;N NI;;;Stream type name\n"
    "StreamKindID;;;N NI;;;Number of the stream (base=0)\n"
    "StreamKindPos;;;N NI;;;When multiple streams, number of the stream (base=1)\n"
    "Inform;;;N NT;;;Last **Inform** call\n"
    ...
    "Format_Settings_MuxingMode;;;Y NT;;;Settings needed for decoder used, detailled\n"
    "Format_Settings_PacketBitStream;;;N NT;;;Deprecated\n"
    ...
    "Codec_Settings_GMC;; warppoints;N NT;;;Deprecated\n"
    ...
    "Codec_Settings_RefFrames;; frames;N NT;;;Deprecated\n"
    "Duration;; ms;N YI;;;Play time of the stream\n"
    "Duration/String;;;Y NT;;;Play time (formated)\n"
    "Duration/String1;;;N NT;;;Play time in format : HHh MMmn SSs MMMms, XX omited if zero\n"
    "Duration/String2;;;N NT;;;Play time in format : XXx YYy only, YYy omited if zero\n"
...
void File__Base_Audio (ZtringListList &Info)
{
    ...
    "Count;;;N NI;;;Count of objects available in this stream\n"
    "StreamCount;;;N NI;;;Count of streams of that kind available\n"
    "StreamKind;Audio;Audio;N NI;;;Stream type name\n"
    "StreamKindID;;;N NI;;;Number of the stream (base=0)\n"
    "StreamKindPos;;;N NI;;;When multiple streams, number of the stream (base=1)\n"
    "Inform;;;N NT;;;Last **Inform** call\n"
    "ID;;;N YI;;;A ID for this stream in this file\n"
...
void File__Base_Text (ZtringListList &Info)
{
    ...
    "Count;;;N NI;;;Count of objects available in this stream\n"
    "StreamCount;;;N NI;;;Count of streams of that kind available\n"
    "StreamKind;Text;Text;N NI;;;Stream type name\n"
    "StreamKindID;;;N NI;;;Number of the stream (base=0)\n"
    "StreamKindPos;;;N NI;;;When multiple streams, number of the stream (base=1)\n"
    "Inform;;;N NT;;;Last **Inform** call\n"
    "ID;;;N YI;;;A ID for this stream in this file\n"
...
void File__Base_Chapters (ZtringListList &Info)
{
    ...
    "Count;;;N NI;;;Count of objects available in this stream\n"
    "StreamCount;;;N NI;;;Count of streams of that kind available\n"
    "StreamKind;Chapters;Chapters;N NI;;;Stream type name\n"
    "StreamKindID;;;N NI;;;Number of the stream (base=0)\n"
    "StreamKindPos;;;N NI;;;When multiple streams, number of the stream (base=1)\n"
    "Inform;;;N NT;;;Last **Inform** call\n"
    "ID;;;N YI;;;A ID for this stream in this file\n"
...
void File__Base_Image (ZtringListList &Info)
{
    ...
    "StreamKind;Image;Image;N NI;;;Stream type name\n"
    "StreamKindID;;;N NI;;;Number of the stream (base=0)\n"
    "StreamKindPos;;;N NI;;;When multiple streams, number of the stream (base=1)\n"
    "Inform;;;N NT;;;Last **Inform** call\n"
    "ID;;;N YI;;;A ID for this stream in this file\n"
...
void File__Base_Menu (ZtringListList &Info)
{
    ...
    "Count;;;N NI;;;Count of objects available in this stream\n"
    "StreamCount;;;N NI;;;Count of streams of that kind available\n"
    "StreamKind;Menu;Menu;N NI;;;Stream type name\n"
    "StreamKindID;;;N NI;;;Number of the stream (base=0)\n"
    "StreamKindPos;;;N NI;;;When multiple streams, number of the stream (base=1)\n"
    "Inform;;;N NT;;;Last **Inform** call\n"
    "ID;;;N YI;;;A ID for this stream in this file\n"
