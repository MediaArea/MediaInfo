...
void File__Base_General (ZtringListList &Info)
{
    ...
    "Ligthness;;;Y YT;;;Describes the changes in lightness settings on the digitizer required to produce the file;;Technical\n"
...
void File__Base_Video (ZtringListList &Info)
{
    ...
    "Codec_Settings_RefFrames;; frame;N NT;;;Deprecated, do not use in new projects\n"
    "Duration;; ms;N YI;;;Play time of the stream in ms\n"
    "Duration/String;;;Y NT;;;Play time in format : XXx YYy only, YYy omited if zero\n"
    "Duration/String1;;;N NT;;;Play time in format : HHh MMmn SSs MMMms, XX omited if zero\n"
    "Duration/String2;;;N NT;;;Play time in format : XXx YYy only, YYy omited if zero\n"
    ...
    "Resolution;; bit;N YI;;;16/24/32 \n"
    "Resolution/String;;;Y NT;;;16/24/32 bits\n"
    "Colorimetry;;;Y YT\n"
    "ScanType;;;N YT\n"
