...
void File__Base_Video (ZtringListList &Info)
{
    ...
    "Format_Settings_GMC;; warppoint;N NI;;;Settings needed for decoder used, detailled\n"
    ...
    "Format_Settings_RefFrames;; frame;Y NT;;;Settings needed for decoder used, detailled\n"
    ...
    "Codec_Settings_RefFrames;; frame;N NT;;;Deprecated\n"
    "Duration;; ms;N YI;;;Play time of the stream\n"
    "Duration/String;;;Y NT;;;Play time (formated)\n"
    "Duration/String1;;;N NT;;;Play time in format : HHh MMmn SSs MMMms, XX omited if zero\n"
    "Duration/String2;;;N NT;;;Play time in format : XXx YYy only, YYy omited if zero\n"
