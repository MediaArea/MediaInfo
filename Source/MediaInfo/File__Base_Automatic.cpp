...
void File__Base_DefaultLanguage (Translation &Info)
{
    ...
    "Played_Count;Count of playings\n"
    "Played_First_Date;First playing\n"
    "Played_Last_Date;Last playing\n"
    "PlayTime;PlayTime\n"
    "Position;Position\n"
...
void File__Base_General (ZtringListList &Info)
{
    ...
    "OverallBitRate_Mode/String;;;Y NT;;;Bit rate mode of all streams (VBR, CBR)\n"
    "OverallBitRate;; bps;N YF;;;Bit rate of all streams\n"
    ...
    "Added_Date;;;Y YT;;;;;Personal\n"
    "Played_First_Date;;;Y YT;;;;;Personal\n"
    "Played_Last_Date;;;Y YT;;;;;Personal\n"
    "Played_Count;;;Y YI;;;;;Personal\n"
    ));
    Info.Separator_Set(0, ZenLib::EOL);
}
