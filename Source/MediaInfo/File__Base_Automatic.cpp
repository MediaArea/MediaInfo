...
void File__Base_DefaultLanguage (Translation &Info)
{
    ...
    "Extensions;Extensions usualy used\n"
    "Family;Family\n"
    "Fax;Fax\n"
    "File;File\n"
    "File size;File size\n"
...
void File__Base_General (ZtringListList &Info)
{
    ...
    "OveralBitRate_Mode;;;N YT;;;Bit rate mode of all streams (VBR, CBR)\n"
    "OveralBitRate_Mode/String;;;Y NT;;;Bit rate mode of all streams (VBR, CBR)\n"
...
void File__Base_Video (ZtringListList &Info)
{
    ...
    "BitRate_Mode/String;;;Y NT;;;Bit rate mode (VBR, CBR)\n"
    ...
    "FrameRate_Mode/String;;;Y NT;;;Frame rate mode (CFR, VFR)\n"
