...
//---------------------------------------------------------------------------
void File__Analyze::Streams_Finish_Cosmetic()
{
    //Generic
    for (size_t StreamKind=Stream_General; StreamKind<Stream_Max; StreamKind++)
        for (size_t StreamPos=0; StreamPos<Count_Get((stream_t)StreamKind); StreamPos++)
            Streams_Finish_Cosmetic((stream_t)StreamKind, StreamPos);

    //For each kind of (*Stream)
    for (size_t Pos=0; Pos<Count_Get(Stream_General);  Pos++) Streams_Finish_Cosmetic_General(Pos);
    for (size_t Pos=0; Pos<Count_Get(Stream_Video);    Pos++) Streams_Finish_Cosmetic_Video(Pos);
    for (size_t Pos=0; Pos<Count_Get(Stream_Audio);    Pos++) Streams_Finish_Cosmetic_Audio(Pos);
    for (size_t Pos=0; Pos<Count_Get(Stream_Text);     Pos++) Streams_Finish_Cosmetic_Text(Pos);
    for (size_t Pos=0; Pos<Count_Get(Stream_Chapters); Pos++) Streams_Finish_Cosmetic_Chapters(Pos);
    for (size_t Pos=0; Pos<Count_Get(Stream_Image);    Pos++) Streams_Finish_Cosmetic_Image(Pos);
    for (size_t Pos=0; Pos<Count_Get(Stream_Menu);     Pos++) Streams_Finish_Cosmetic_Menu(Pos);
}

//---------------------------------------------------------------------------
void File__Analyze::Streams_Finish_Cosmetic(stream_t StreamKind, size_t Pos)
{
}

//---------------------------------------------------------------------------
void File__Analyze::Streams_Finish_Cosmetic_General(size_t StreamPos)
{
}

//---------------------------------------------------------------------------
void File__Analyze::Streams_Finish_Cosmetic_Video(size_t Pos)
{
}

//---------------------------------------------------------------------------
void File__Analyze::Streams_Finish_Cosmetic_Audio(size_t Pos)
{
}

//---------------------------------------------------------------------------
void File__Analyze::Streams_Finish_Cosmetic_Text(size_t Pos)
{
}

//---------------------------------------------------------------------------
void File__Analyze::Streams_Finish_Cosmetic_Chapters(size_t StreamPos)
{
}

//---------------------------------------------------------------------------
void File__Analyze::Streams_Finish_Cosmetic_Image(size_t StreamPos)
{
}

//---------------------------------------------------------------------------
void File__Analyze::Streams_Finish_Cosmetic_Menu(size_t StreamPos)
{
}
