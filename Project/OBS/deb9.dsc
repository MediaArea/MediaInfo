...
Build-Depends: debhelper (>= 9), dh-autoreconf, libmediainfo-dev (>= 0.7.88), libzen-dev (>= 0.4.33), libwxgtk3.0-dev, adwaita-icon-theme, humanity-icon-theme, zlib1g-dev, pkg-config
Package-List:
